...
const ATMPrintOrganism = (props: ATMPrintOrganismProps) => {
  ...
  return (
    <Box
      ...
      <Typography variant='h5' color='secondary' mb={4}>{`Se imprimira tu comprobante de ${props.type === 'deposit' ? 'Deposito' : props.type === 'withdraw' ? 'Retiro' : 'Consulta de Saldo'}`}</Typography>
