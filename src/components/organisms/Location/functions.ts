export const createProvince = async (provinceName: string) => {
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/province`;
  const options = {
    method: "POST",
    headers: {
...
export const createCanton = async (
  ...
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/canton`;
  const options = {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
export const createParish = async (
  ...
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/parish`;
  const options = {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
export const getProvinces = async () => {
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/provinces`;
  const options = {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
export const getCantons = async () => {
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/cantons`;
  const options = {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
export const getParishes = async () => {
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/parishes`;
  const options = {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
export const updateProvince = async (
  ...
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/province/${provinceName}`;
  const options = {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
...
export const updateCanton = async (
  ...
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/canton/${cantonName}`;
  const options = {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
...
export const updateParish = async (
  ...
  const url = `https://settingsbanquitoapp-kjduy-dev.apps.sandbox-m3.1530.p1.openshiftapps.com/api/location/parish/${parishName}`;
  const options = {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
